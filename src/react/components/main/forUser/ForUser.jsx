...
import {MENU, MAIN_ID, FOR_USER} from '../../../constants/constants';
...
class ForUser extends React.Component {
  ...
  render() {
    ...
    const content = (
      <AuthSuccess>
        <Jumbotron>
          <LinksTable data={data} ths={['Пользователю']}/>
        </Jumbotron>
      </AuthSuccess>
    );
    return (
